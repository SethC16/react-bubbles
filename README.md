...
- [ ] Explain what a token is used for.
      **_a simple way for securely transmitting information between client and server as a JSON object_**
- [ ] What steps can you take in your web apps to keep your data secure?
      **_keep software up-to-date, enforce strong password policy, encrypt your login pages, use a secure host, keep website clean, backup data, etc_**
- [ ] Describe how web servers work.
      **_Processes incoming network requests made over HTTP and other protocols. Primary function is to store, process, and deliver web pages to client_**
- [ ] Which HTTP methods can be mapped to the CRUD acronym that we use when interfacing with APIs/Servers.
      **_Create = PUT, POST / Read = GET / Update = PUT / Delete = DELETE_**
